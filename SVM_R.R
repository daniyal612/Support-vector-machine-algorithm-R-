...
movie <- read.csv("E:/Machine Learning With R/Data Files/Data Files/Support Vector Machines Dataset/Movie_classification.csv", header = TRUE)
...
table(predict = ypredP, tryth =  testc$Start_Tech_Oscar)
...
df <- read.csv("E:/Machine Learning With R/Data Files/Data Files/Support Vector Machines Dataset/Movie_regression.csv", header = TRUE)
